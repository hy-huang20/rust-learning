...
/// embassy-executor-macros 中 main_std 函数
/// 
/// 如果执行 main_std 函数则一定会执行 main.rs 
/// 中的 run 函数，而 run 函数针对一些非法情况
/// 有相应的输出，输出在编译错误中
/// 
/// 可以直接在 main_std 开头使用 println! 输出
/// 自定义内容以验证。比如修改 src/lib.rs 中的
/// main_std 为：
/// 
